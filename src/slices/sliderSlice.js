...
const sliderSlice = createSlice({
   ...
   extraReducers: (builder) => {
      builder.addCase(fetchSliderItems.pending, state => { state.sliderItemsLoadingStatus = 'loading' })
      ...
      builder.addCase(fetchSliderItems.rejected, state => { state.sliderItemsLoadingStatus = 'error' })
